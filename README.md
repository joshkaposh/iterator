...
| flat_map(fn: (value: A) => B): FlatMap | Creates an iterator that flattens and maps an iterator of nested iterators. <br /> Ex. [[1]], [2], [3]].flat_map(v => v * v).collect() == [1, 4, 9]. See 'flatten()' for more information.  |
